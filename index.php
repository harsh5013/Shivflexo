	...
	<div class="container">
		<nav class="navbar navbar-expand-lg navbar-light">
			<a class="navbar-brand" href="index.html">
				<i class="fas fa-boxes"></i>Shiv Flexo
			</a>
	...
	<div class="container-fluid py-lg-5 py-3">
		<div class="row service_grids">
			<div class="col-lg-2 col-md-3 mb-lg-0 mb-5 ser_grid1 icon1">
				...
				<h3>Service One </h3>
				<p>Printing All Types of BOPP Bags</p>
			...
			<div class="col-lg-2 col-md-3 mb-lg-0 mb-5 ser_grid1 icon2">
				...
				<h3>Service Two</h3>
				<p>Manufactring All Type of BOPP Bags</p>
				<a href="#">Read More <span class="fa fa-angle-right"></span></a>
			</div>
...
<section class="team py-5 my-lg-5 my-3">
	...
	<div class="row team_grids">
		...
		<div class="col-lg-2 col-md-3 col-6 mb-md-0 mb-5 w3l_team_grid">
			...
			<h4 class="my-2">Rameshbhai Patel</h4>
			<p>CEO & Founder</p>
		</div>
		<div class="col-lg-2 col-md-3 col-6 mb-md-0 mb-5 w3l_team_grid">
			<div class="view view-second">
			...
			<h4 class="my-2">Pravinbhai patel</h4>
			<p>Co-founder</p>
		</div>
		<div class="col-lg-2 col-md-3 col-6 w3l_team_grid">
			...
			<h4 class="my-2">Kaushal Patel</h4>
			<p>General Manager</p>
		</div>
		<div class="col-lg-2 col-md-3 col-6 w3l_team_grid">
			<div class="view view-second">
			...
			<div class="row w3_agile-footer-grids py-5">
				...
				<div class="col-lg-7 col-sm-9 mb-sm-0 mb-4 px-sm-0 px-4 row w3_agile-footer1 f2">
					...
					<div class="col-lg-6 col-sm-7  mb-sm-0 mb-4 inner-li">
						...
						<ul class="w3ls-footer-bottom-list">
							<li> <span class="fas fa-map-marker"></span> Bhadravti Society,Old Panch Pipla Road,Jetpur(360370),Gujarat</span></li>
							<li> <span class="fas fa-envelope"></span> <a href="mailto:omflexo.help.5013@gamail.com"> mail@gmail.com</a> </li>
							<li> <span class="fas fa-phone"></span> +91 942 617 5013</li>
							<!-- <li> <span class="fas fa-globe"></span> <a href="#"> www.website.com</a> </li> -->
							<li> <span class="fas fa-clock"></span> Working Hours : 8:00 a.m - 8:00 p.m</li>
						</ul>
					</div>
				...
				<div class="col-lg-3 col-md-12 px-sm-0 px-4 w3_agile-footer1 f3">
					...
					<ul class="tweet-agile">
						<li>
							<p class="tweet-p1"><span class="fab fa-twitter" aria-hidden="true"></span><a href="mailto:omflexo.help.5013@gamail.com">@Bholu</a> Excellent Working. <a href="#"></a></p>
							<p class="tweet-p2">Posted 2 days ago.</p>
						</li>
						<li>
							<p class="tweet-p1"><span class="fab fa-twitter" aria-hidden="true"></span><a href="mailto:omflexo.help.5013@gamail.com">@ppsolanki</a> Very Nice Printing . <a href="#"></a></p>
